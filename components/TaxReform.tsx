    ...
    <section className="py-20 bg-slate-900 text-white relative overflow-hidden" id="tax-reform">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-16">
          ...
          >
            <div className="rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-slate-800">
              <img 
                ...
                className="w-full h-[400px] object-cover grayscale brightness-90 hover:grayscale-0 transition-all duration-700"
              />
            </div>
          </motion.div>
          ...
          <div className="lg:w-1/2 w-full">
            <SectionReveal>
              ...
              <p className="text-xl md:text-2xl font-medium text-slate-300 mb-10 leading-snug">
              ...
              <div className="space-y-4">
                {points.map((point, index) => (
                  <motion.div 
                    ...
                    className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/10 hover:border-primary/30 transition-all shadow-sm"
                  >
                    <CheckCircle2 className="w-6 h-6 text-primary shrink-0" />
                    <span className="font-bold text-sm md:text-base uppercase tracking-wide text-slate-100">{point}</span>
                  </motion.div>
                ))}
              </div>
            </SectionReveal>
        ...
        <SectionReveal delay={0.6} className="text-center max-w-4xl mx-auto">
          <p className="text-xl md:text-2xl font-bold text-white mb-10 leading-relaxed">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-block text-primary font-bold text-sm uppercase tracking-[0.2em] underline underline-offset-8 transition-colors hover:text-[#900018]"
          >
